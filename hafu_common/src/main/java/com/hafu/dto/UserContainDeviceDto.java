 ...
 * 用户表 dto (包含其设备列表)
 */
public class UserContainDeviceDto{
	...
	private String mobile; //  手机号 VARCHAR(15) 15 是    
	 ...
	 //业务
	 private List<HfDevice> deviceList; //该人与关注人相关所有设备
	 private Long concernUserId;//关注人id
	...
	public List<HfDevice> getDeviceList() {
		return deviceList;
	}
	public void setDeviceList(List<HfDevice> deviceList) {
