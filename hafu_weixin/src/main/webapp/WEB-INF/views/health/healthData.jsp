			...
			<div class="content">
				...
				<div class="pagePadding">
					...
					<ul class="pageMenuUL1">
						<li class="alone w25">血压</li>
						<li class="alone w25">血常规</li>
						<li class="alone w25">血糖</li>
						<li class="alone w25">尿检</li>
					</ul>
						...
						<div id="Nj">
							<div class="divStyle5">
								<div class="left" style="width: 50%;">
									<span>LEU(白细胞)：</span><!-- <span>阴性</span> -->
								</div>
								<div class="right" style="width: 50%;">
									<span>BLD(隐血)：</span><!-- <span>+2</span> -->
								</div>
							</div>
							<div class="divStyle5">
								<div class="left" style="width: 50%;">
									<span>NIT(亚硝酸盐)：</span><!-- <span>阴性</span> -->
								</div>
								<div class="right" style="width: 50%;">
									<span>KET(胴体)：</span><!-- <span>弱阳性</span> -->
								</div>
							</div>
							<div class="divStyle5">
								<div class="left" style="width: 50%;">
									<span>UBG(尿胆原)：</span><!-- <span>+2</span> -->
								</div>
								<div class="right" style="width: 50%;">
									<span>BIL(尿胆红素)：</span><!-- <span>阴性</span> -->
								</div>
							</div>
							<div class="divStyle5">
								<div class="left" style="width: 50%;">
									<span>PRO(尿蛋白)：</span><!-- <span>+2</span> -->
								</div>
								<div class="right" style="width: 50%;">
									<span>GLU(尿葡萄糖)：</span><!-- <span>阴性</span> -->
								</div>
							</div>
							<div class="divStyle5">
								<div class="left" style="width: 50%;">
									<span>PH(酸碱度)：</span><!-- <span>5.0</span> -->
								</div>
								<div class="right" style="width: 50%;">
									<span>VC(尿透明度)：</span><!-- <span>微浑</span> -->
								</div>
							</div>
							<div class="divStyle5">
								<div class="left" style="width: 50%;">
									<span>SG(尿比重)：</span><!-- <span><=1.005</span> -->
								</div>
								<div class="right" style="width: 50%;">
									<span>MA：</span><!-- <span>正常</span> -->
								</div>
							</div>
							<div class="divStyle5">
								<div class="left" style="width: 50%;">
									<span>CA：</span><!-- <span>1.0</span> -->
								</div>
								<div class="right" style="width: 50%;">
									<span>CR：</span><!-- <span>0.9</span> -->
								</div>
							</div>
						</div>
					...
					<div class="clear margin_top2">
						<c:choose>
							<c:when test="${type==4 }"><div style="width: 100%"></c:when>
							<c:otherwise><div class="myLeft width_p48"></c:otherwise>
						</c:choose>
						...
						<div class="myRight width_p48">
							<c:choose>
								<c:when test="${type==1}">
									<div class="mySubmit2" onclick="window.location.href='/health/toAddCheckData?type=XY'">手动添加</div>
								</c:when>
								<c:when test="${type==2}">
									<div class="mySubmit2" onclick="window.location.href='/health/toAddCheckData?type=XZ'">手动添加</div>
								</c:when>
								<c:when test="${type==3}">
									<div class="mySubmit2" onclick="window.location.href='/health/toAddCheckData?type=XT'">手动添加</div>
								</c:when>
							</c:choose>
						</div>
					</div>
...
<script src="/static/js/top.js" type="text/javascript" charset="utf-8"></script>
	...
	<script type="text/javascript">
		$(function() {
			...
			var color=new Array();
			var address;
			var colors={"步数":"#52d0c2","时长":"#52d0c2","舒张压":"#669ef3","收缩压":"#b980eb","总胆固醇":"#669ef3","白细胞":"#fea645","血氧":"#b87fea",
					"血红蛋白":"#52d0c2","血压":"#52d0c2","血糖":"#52d0c2","心率":"#52d0c2","睡眠":"#52d0c2","消耗卡路里":"#b980eb","摄入热量":"#669ef3"};
			var categories = new Array();
			var unit={"舒张压":"mmHg","收缩压":"mmHg","总胆固醇":"mmol/L","血氧":"%","白细胞":"g/L","血红蛋白":"g/L","血糖":"mmol/L"}
			$.ajax({
				...
				success : function(d) {
					for ( var p in d) {
						if (p == 'date') {
							...
							temp.data = d[p];
							if ((p == "舒张压" && '${type}' == 1)
									|| (p == "收缩压" && '${type}' == 1)||(p == "血压" && '${type}' == 1)) {
								series.push(temp);
								color.push(colors[p]);
							} else if (('${type}' == 2 && p == "总胆固醇")
									|| ('${type}' == 2 && p == "血氧")
									|| ('${type}' == 2 && p == "白细胞")
									|| ('${type}' == 2 && p == "血红蛋白")) {
								series.push(temp);
						...
						}else if(p=='JKSJ_XTaddress'||p=='JKSJ_XZaddress'||p=='JKSJ_XYaddress'){
							if('${type}'==1&&p=='JKSJ_XYaddress'){
								address=d[p];
							}else if('${type}'==2&&p=='JKSJ_XZaddress'){
								address=d[p];
							}else if('${type}'==3&&p=='JKSJ_XTaddress'){
								address=d[p];
							}
						}
					}
			...
			$("ul.pageMenuUL1 li").each(function() {
				...
				$(this).bind("click", function() {
					window.location.href = "/health/healthData?type=" + index;
				});
			});
