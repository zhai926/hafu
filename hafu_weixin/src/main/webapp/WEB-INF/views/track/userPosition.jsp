...
<script src="/static/js/layer/layer.js"  async="async"></script>
...
<body>
	<div class="content" >
		...
		<div class="content-wrap" style="height:100%;padding-bottom:0 ">
			 <div class="pagePadding">
				<ul class="pageMenuUL1 row" style="text-align: center;height:100%;border: none;">
					...
					<span class="in"><b id="time" style="margin-left: 45px; font-size: 14px;color: #a9a9ab;float: left;margin-top: 13px;"><%= (new java.util.Date()).toLocaleString().substring(0,(new java.util.Date()).toLocaleString().length()-8) %></b></span>
