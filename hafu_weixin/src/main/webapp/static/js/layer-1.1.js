...
function(a) {
    ...
    j.prototype.view = function() {
		...
		//alert(z);
        if (c.fixed || (c.top = c.hasOwnProperty("top") ? c.top: 100, c.style = c.style || "", c.style += " top:" + (b.body.scrollTop + c.top) + "px"), 2 === c.type && (c.content = '<i></i><i class="laymloadtwo"></i><i></i>'), f.innerHTML = (c.shade ? "<div " + ("string" == typeof c.shade ? 'style="' + c.shade + '"': "") + ' class="laymshade"></div>': "") + '<div'+ (z==1?' class="layermmain myLayer1" ':' class="layermmain"')+ (c.fixed ? "": 'style="position:static;"') + '><div class="section"><div class="layermchild ' + (c.className ? c.className: "") + " " + (c.type || c.shade ? "": "layermborder ") + (c.anim ? "layermanim": "") + '" ' + (c.style ? 'style="' + c.style + '"': "") + ">" + g + '<div class="layermcont">' + c.content + "</div>" + j + "</div></div></div>", !c.type || 2 === c.type) {
...
//        console.log("d == " + d);
        c.getAttribute("merge") || document.head.appendChild(function() {
            ...
            //http://192.168.0.141:8080/hafu_weixin/static/js/need/layer.css
//            console.log("e == " + e);
//            console.log("e == " + e.replace("js", "css"));
//            e = e.replace("js", "css");
